...
import com.example.Vaadin_REST_bib.views.lists.leraar.LKBookList;
import com.example.Vaadin_REST_bib.views.lists.leraar.LK_BorrowList;
import com.example.Vaadin_REST_bib.views.lists.leraar.LK_UserDetails;
...
@RolesAllowed("LK")
@Route("/lk")
public class LKN_MainLayout extends BaseLayout {
    private SecurityService securityService;
    private UserService userService;

    public LKN_MainLayout(SecurityService securityService, UserService userService) {
    ...
    private void createDrawer() {
        ...
        RouterLink bookList = new RouterLink("Boeken", LKBookList.class);
 ...
 /*       RouterLink magazineList = new RouterLink("Magazines", MagazineList.class);
        ...
        RouterLink mijnLijst = new RouterLink("Mijn lijst", LK_BorrowList.class);


        bookList.setHighlightCondition(HighlightConditions.sameLocation());
        mijnLijst.setHighlightCondition(HighlightConditions.sameLocation());
