...
@Route(value = "ll/admin/users", layout = ADMIN_LL_MainLayout.class) //wordt geladen binnen mainlayout
@RolesAllowed({"ADMIN"})
public class UserList extends VerticalLayout {
    ...
    private void updateGrid() {
        grid.setItems(userService.getUsers(filterText.getValue()).getData().getUsers());
    }
